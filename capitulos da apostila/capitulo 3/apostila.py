...
class Personagem:
    ...
    def calcular_dano_base(forca):
        return forca - 50 if forca >= 50 else 0
...
class Jogador():
    ...
    def exibir_total_jogadores(cls): #metodo de classe
...
class Loja:
    ...
    def adicionar_item(self, item):
        ...
        print(f"{item.nome} adicionado na loja {self.nome} por R${item.preco:.2f}")

    @classmethod
    def ajustar_preco_itens(cls, lojas, fator):
        cls.fator_inflacao = fator
        for loja in lojas:
